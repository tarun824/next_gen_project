            ...
            >
              <Dialog.Panel className="rounded-md bg-white w-6/12">
                ...
                >
                  ...
                  <button
                    onClick={() => closeModal()}
                    className=" absolute right-6 top-4 text-gray-500 hover:bg-gray-100 rounded focus:outline-none focus:ring focus:ring-offset-1 focus:border-orange-200 "
                  >
                    <svg
                ...
                <form onSubmit={handleSubmit} className="gap-4 px-8 py-4">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      type="text"
                      className="border border-gray-300 rounded-md w-full text-sm py-2 px-2.5 focus:border-orange-500 focus:outline-offset-1 focus:outline-indigo-400"
