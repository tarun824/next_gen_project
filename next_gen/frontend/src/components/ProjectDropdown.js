          ...
          <div className="w-48 bg-white rounded-md border shadow select-none p-1 divide-y">
            <div className="py-[3px]">
              <button
                ...
                className="transition-colors duration-75 flex w-full items-center rounded-md px-2.5 py-2 text-sm space-x-2.5 text-slate-500 hover:bg-orange-600 hover:text-gray-100"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
