        ...
        .then((res) => {
          ...
          setColumns({
            ...
            [uuid()]: {
              name: "Under review",
              items: res.data[0].task
                .filter((task) => task.stage === "Under review")
                .sort((a, b) => {
                  return a.order - b.order;
                }),
            },
                    ...
                    {(provided, snapshot) => {
                      return (
                        <div
                          ...
                          className={`min-h-[530px] pt-4 duration-75 transition-colors border-t-2 border-orange-400 ${
                            snapshot.isDraggingOver && "border-orange-600"
                          }`}
                        >
                                  ...
                                  return (
                                    ...
                                    >
                                      <div className="pb-2">
                                        ...
                                        <span className="py-1 px-2.5 bg-orange-100 text-indigo-600 rounded-md text-xs font-medium mt-1 inline-block">
                                          Task-{item.index}
                                        </span>
                                      </div>
                                    </div>
